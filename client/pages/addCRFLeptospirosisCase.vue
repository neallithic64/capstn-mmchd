              ...
              <div class="field-row">
                <div class="dateOnset-field field" style="width:30%">
                  ...
                  <select
                    ...
                    >
                      ...
                      <option value="CONTAMINAETD WATER">CONTAMINATED WATER</option>
                    </select>
                </div>
                <div class="dateOnset-field field" style="width:30%; margin-right:50px">
                  ...
                  <input
                    ...
                    :class="isRequired()"
                    required
                    :value="formData.caseData.exposurePlace.toUpperCase()"
                    @input="formData.caseData.exposurePlace = $event.target.value.toUpperCase()"
                  />
                </div>
              </div>
            </div>
