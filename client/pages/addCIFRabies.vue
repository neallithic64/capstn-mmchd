    ...
    <div class="addCIF-caseContainer">
      ...
      <div class="addCIF-formSectionContainer">
        ...
        <div class="addCIF-formComponent">
          <form v-if="pageNum == 0" id="Rabies0" type="submit">
          ...
          <form v-if="pageNum == 6 || pageNum == Object.keys(disease.formNames).length" id="Rabies6" type="submit">
            <div id="case-investigation-form" class="center">
              <h2 id="addCIF-formHeader">
                {{ Object.values(disease.formNames)[pageNum] }}
              </h2>
...
export default {
  middleware: 'is-auth',
  header: {
    title: 'Case Investigation Form - Rabies',
  },
  data() {
    return {
      patientExist: false,
      ...
      categoryExposure: [
        ...
        'Licking of intact skin(with reliable history and thorough physica! examination)',
        'Exposure to patient with signs and symptoms ofrabies by sharing of eating or drinking untensils',
        'Casual contact(talking to, visiting and feeding suspected rabies cases) and routine delivery of health care to patient withsigns and symptoms of rabies',
        ...
        'All Category II exposures on the head and neck area are considered Category Ill and should be managed as such',
        ...
        'Exposure to a rabies patient through bites,contamination of mucous membranes(eyes,oral/nasal mucosa,genital/anal mucous membranes) or Open skin lesions with body fluids through splattering and mouth-to-mouth resuscitation.',
    ...
    validateForm(page) {
      switch (page) {
        ...
        case 3:
          if (
            (
            this.formData.caseData.exposureBite ||
            this.formData.caseData.exposureScratch ||
            this.formData.caseData.exposureAffectedSite ||
            this.formData.caseData.exposureSaliva ||
            this.formData.caseData.exposureConsumedMeat ||
            this.formData.caseData.exposureUnknown ||
            this.formData.caseData.exposureOthers) &&
            (
            this.formData.caseData.exposeDate &&
            this.formData.caseData.exposePlace
            ) &&
            Object.keys(this.formData.caseData.categoryExposure).length>0 &&
            (
                this.formData.caseData.exposeAnimal &&
                this.formData.caseData.exposeAnimalStatus
            ) 
          ) this.pageDone[page] = true;
          else this.pageDone[page] = false;
          break;
        case 4:
          if (this.formData.caseData.vaccinationHistory &&
              this.formData.caseData.woundClean &&
              this.formData.caseData.patientRIG &&
              this.formData.caseData.patientVaccine
          ) if ( this.formData.caseData.vaccinationHistory!=='Vaccinated' || (
              this.formData.caseData.vaccinationHistory==='Vaccinated' &&
              this.formData.caseData.vaccineDateStart &&
              this.formData.caseData.vaccineBrand &&
              this.formData.caseData.routeAdmin &&
              this.formData.caseData.postExposure)
            ) this.pageDone[page] = true;
            else this.pageDone[page] = false;
          else this.pageDone[page] = false;
          break;
