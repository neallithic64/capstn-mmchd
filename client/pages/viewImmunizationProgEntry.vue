                    ...
                    <tbody>
                      <template>
                            ...
                            <tr>
                              ...
                              <td rowspan="3"> <span v-if="loadedData[0].PCV1date != '' && loadedData[0].PCV2date != '' && loadedData[0].PCV3date != '' " style="display: inline-flex"> <img src="~/assets/img/check.png" class="complete"/> </span> </td>
                            </tr>
                            <tr>
                              <th> 2 </th>
